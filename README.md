...
|领域分类|核心内容|资源状态|实战链接|
|---|---|---|---|
|**AI 大模型（重点）**|开源大模型、图像模型、Embedding/Reranker、智能体、协议调用|✅ 深度解析+实战案例|
|产品经理|书籍笔记、产品设计、文档模板、工具应用|✅ 分类整理+工具链接|
|项目管理|数据模板、协作方法、实战案例|✅ 可直接复用资源|
|工具集|数据库、数据分析、提示词调优工具|✅ 工具对比+使用指南|
## 🤖 核心板块：AI 大模型技术栈
...
- **图像模型**：涵盖 Stable Diffusion、MidJourney（API 调用）、DALL·E 系列，对比生成质量、速度、自定义能力

- **Embedding & Reranker 模型**：实测 BGE、m3e、E5 等 Embedding 模型语义相似度能力，对比 Cohere Rerank、Cross-BERT 等 Reranker 效果
